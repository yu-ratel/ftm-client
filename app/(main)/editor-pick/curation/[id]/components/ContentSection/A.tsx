...
export default function ContentSectionA({
  ...
  return (
    <section className="mt-[60px] flex flex-col whitespace-pre-line lg:mt-[120px]">
      ...
      <section className="mt-12 flex flex-col gap-12 lg:h-[700px] lg:flex-row *:lg:w-1/2">
        <div className="flex flex-col gap-6">
          ...
          <ImageWrapper src={img02} className="h-[309px] lg:h-[618px]" />
        </div>
        <div className="flex flex-col gap-6">
          <TextSection title={text04.title} description={text04.description} />
          <ImageWrapper src={img03} className="h-[309px] lg:h-[618px]" />
        </div>
      </section>

      <section className="my-12 flex flex-col gap-12 lg:my-40">
        <ImageWrapper src={img04} className="h-[320px] lg:h-[640px]" />
        <div className="flex w-full flex-col gap-12 lg:flex-row *:lg:w-1/2">
          ...
          <div className="flex flex-col gap-12">
            ...
            <ImageWrapper
              src={img05}
              className="h-[200px] object-contain lg:h-[400px]"
            />
          </div>
        </div>
        <div className="flex flex-col items-end gap-12 *:w-full lg:flex-row *:lg:w-1/2">
          <ImageWrapper
            src={img06}
            className="h-[400px] object-contain lg:h-[800px]"
          />
